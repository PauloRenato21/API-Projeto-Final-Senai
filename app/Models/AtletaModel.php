...
class AtletaModel extends Model{
    ...
    protected $allowedFields = ['nome','cpf','dt_nascimento','endereco_rua','endereco_bairro','endereco_CEP','naturalidade','problema_saude','alergia','medicamento','telefone','email'];
